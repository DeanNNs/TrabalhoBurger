...
CREATE TABLE IF NOT EXISTS `mydb`.`cliente` (
  ...
  PRIMARY KEY (`idcliente`, `historico_idhistorico`),
...
CREATE TABLE IF NOT EXISTS `mydb`.`entrega` (
  ...
  `entregador_idfuncionario` INT NOT NULL,
  PRIMARY KEY (`identrega`, `cliente_idusuario`, `pedido_idpedido`),
  UNIQUE INDEX `identrega_UNIQUE` (`identrega` ASC) VISIBLE,
  UNIQUE INDEX `endereco_UNIQUE` (`endereco` ASC) VISIBLE,
  INDEX `fk_entrega_cliente1_idx` (`cliente_historico_idhistorico` ASC) VISIBLE,
  INDEX `fk_entrega_pedido1_idx` (`pedido_historico_idhistorico` ASC) VISIBLE,
  INDEX `fk_entrega_entregador1_idx` (`entregador_idfuncionario` ASC) VISIBLE,
  CONSTRAINT `fk_entrega_cliente1`
    FOREIGN KEY (`cliente_historico_idhistorico`)
    REFERENCES `mydb`.`cliente` (`historico_idhistorico`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_entrega_pedido1`
    FOREIGN KEY (`pedido_historico_idhistorico`)
    REFERENCES `mydb`.`pedido` (`historico_idhistorico`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_entrega_entregador1`
    FOREIGN KEY (`entregador_idfuncionario`)
...
CREATE TABLE IF NOT EXISTS `mydb`.`cliente_combo` (
  ...
  CONSTRAINT `fk_cliente_has_combo_cliente1`
    ...
    REFERENCES `mydb`.`cliente` (`idcliente` , `historico_idhistorico`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
