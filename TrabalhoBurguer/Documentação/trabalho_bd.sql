...
CREATE TABLE IF NOT EXISTS `mydb`.`cliente` (
  ...
  UNIQUE INDEX `idusuario_UNIQUE` (`idcliente` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`entrega` (
  ...
  INDEX `fk_entrega_carrinho1_idx` (`carrinho_idcarrinho` ASC) VISIBLE,
  CONSTRAINT `fk_entrega_entregador1`
    FOREIGN KEY (`entregador_identregador`)
    REFERENCES `mydb`.`entregador` (`idfuncionario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
